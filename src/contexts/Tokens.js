...
export const M_WETH_ADDRESS = process.env.REACT_APP_WETH_ADDRESS
...
export const M_TOKENS = {
  1: {
    ...
    [ETH_TOKEN_ID]: {
      ...
      [UNDERLYING_ADDRESS]: WETH_ADDRESS,
      [UNDERLYING_NAME]: INITIAL_TOKENS_CONTEXT['1'][WETH_ADDRESS].name,
      [UNDERLYING_SYMBOL]: INITIAL_TOKENS_CONTEXT['1'][WETH_ADDRESS].symbol,
      [M_ADDRESS]: M_WETH_ADDRESS,
      [M_NAME]: `DMM: ETH`,
      [M_SYMBOL]: `mETH`,
    },
  }
