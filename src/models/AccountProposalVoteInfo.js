...
export class AccountProposalVoteInfo {
  ...
  static toFormattedVoteString(voteStatus, t) {
    return t('vote.'+voteStatus);
  ...
  static toFormattedVoteButtonString(voteStatus, t) {
    return AccountProposalVoteInfo.toFormattedVoteString(voteStatus, t).toUpperCase()
  }
